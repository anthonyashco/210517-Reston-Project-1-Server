...
USER_2 = User(None, "test_2@fake.email", "153417bd132637ba71cf236c323a55bd",
              ...
              "manager")
REQUEST_1 = Request(None, 0, 200.00, "I can haz reimburse for laptop?", None,
                    None, None, None)
REQUEST_2 = Request(None, 0, 5.00,
                    "Venti iced caramel macchiato for the meeting.", None, None,
                    None, None)
